...
const BurgerCard = ({ title, image, review, price }: Props) => {
  return (
    <div className='bg-white p-6 rounded-lg m-3'>
      ...
      <div className='flex items-center mt-[0.5rem] space-x-3'>
        ...
        <div className='text-black opacity-60'> ({review}) </div>
      </div>
      <p className='mt-[0.5rem] text-black text-opacity-70'>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Fugit, itaque!</p>
      <div className='flex mt-[1.4rem] items-center justify-between '>
        <h1 className='text-[25px] font-bold text-red-600'>${price}</h1>
        <button className='px-2 py-2 hover:bg-green-700 transition-all duration-200 bg-orange-600 flex items-center rounded-md text-white'>
