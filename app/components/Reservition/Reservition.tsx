    ...
    return (
        <div className="pt-[5rem] bg-center bg-cover relative mt-[2rem] pb-[5rem] mb-[3rem] bg-[url('/images/bg-black.jpg')]">
            ...
            <div className='w-[80%] relative z-[20] mx-auto grid grid-cols-1 lg:grid-cols-2 items-center gap-[3rem]'>
                {/* text */}
                <div>
                    <h1 className='text-[30px md:text-[40px] lg:text-[50px] text-white font-bold leading-[3rem] md:leading-[4rem]'>DO YOU HAVE ANY DINNER PLAN TODAY? RESERVE YOUR TABLE</h1>
                    <p className='text-[17px] mt-[1rem] text-white text-opacity-50'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ullam sit aspernatur quisquam fugiat similique quia cumque sunt ad quo harum sequi, pariatur provident, blanditiis est?</p>
                    <div className='flex mt-[2rem] items-center space-x-4 '>
                        ...
                        <div>
                            ...
                            <h1 className='text-yellow-300 text-[30px] font-bold'>+919 027 7976</h1>
                        </div>
                    </div>
                </div>
