...
const FormBox = () => {
    return (
        <div className='bg-green-700 p-6 rounded-lg'>
            ...
            <p className='text-white font-semibold uppercase text-[20px] md:text-[25px] text-center '>Book your table </p>
            <div className='mt-[2rem] '>
                ...
                <input type="time" className='px-10 py-2.5 bg-transparent block w-[80%] mx-auto mt-[1rem] rounded-lg outline-none font-bold text-[17px] text-white border-[2.2px] border-fray-100' />
